...
## Parameters
```powershell
E:\NAS_Scripts\Github\Scripts\Powershell\.Scripts\Check-AzureAppsCredExpiration\Check-AzureAppsCredExpiration.ps1 [[-VerboseLvl] <Byte>] [-AllowBeta] [<CommonParameters>]
